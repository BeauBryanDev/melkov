...
LOUVRE: Final[Museum] = Museum(qid="Q19675", source="louvre", display_name="Louvre Museum")


def louvre_search(query: str, limit: int = MUSEUM_SEARCH_LIMIT) -> dict[str, Any]:
    """Search Louvre Museum works by title or artist."""
    return search_museum(LOUVRE, query, limit)
